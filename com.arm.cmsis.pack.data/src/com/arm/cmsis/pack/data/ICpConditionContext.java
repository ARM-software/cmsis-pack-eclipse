 ...
 * <p>
 * Caches overall evaluation result as well as results or individual conditions
 * and expressionsf
 * <p>
 * Underlying IAttributes provides methods to manage device and toolchain filter
 * attributes
 *
...
public interface ICpConditionContext extends IAttributes, IEvaluationResult {
    ...
    /**
     * Evaluates supplied item (component, file, etc.) for given context and returns
     * its result
     *
    ...
    /**
     * Filters supplied collection of items (for example ICpFile items) filtered
