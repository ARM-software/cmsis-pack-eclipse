...
/**
 * Interface that represent device description hierarchy:
...
public interface ICpDeviceItem extends ICpItem {
     ...
     *
     * @return device item parent or null if parent if not device item (family
     *         parent is not a device item)
     */
    ...
    /**
     * Returns effective processor properties for this device item (can be defined
     * at higher level)
     *
    ...
    /**
     * Returns item containing list of effective properties for this device merged
     * with properties from upper levels in device hierarchy
     *
     * @param processorName processor name for which to get properties
     * @return ICpItem containing list of device effective properties for supplied
     *         processor name
     */
