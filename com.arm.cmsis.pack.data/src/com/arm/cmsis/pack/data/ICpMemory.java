...
public interface ICpMemory extends IMemoryPermissions, ICpDeviceProperty  {
	 ...
	 */
	@Override
	default String getAccessString() { return getEffectiveAttribute(CmsisConstants.ACCESS); }
	
	@Override
	default String getSecurityString() { return getEffectiveAttribute(CmsisConstants.SECURITY);}

	@Override
	default String getPrivilegeString() { return getEffectiveAttribute(CmsisConstants.PRIVILEGE);}
	...
	/**
	 * Returns memory type as string that can be used as an XML tag: "RAM", "ROM" or "peripheral"
