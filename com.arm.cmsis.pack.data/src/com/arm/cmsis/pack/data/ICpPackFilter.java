...
public interface ICpPackFilter {
     ...
     *
     * @param packId pack family ID, if pack ID with version is supplied family ID
     *               is extracted
     * @return
     */
     ...
     *
     * @param packId pack ID or pack family ID, if ID contains version, family ID is
     *               extracted
     ...
     *
     * @param packId   pack ID or pack family ID, if ID contains version, family ID
     *                 is extracted
     ...
     *
     * @param packId pack ID with version, if fixed is <code>false</code> family ID
     *               can be used
     ...
     * @param set      of fixed pack versions to use or <code>null</code> to use
     *                 latest
     */
     ...
     * if returned set is empty or null, the family is excluded or uses latest
     * version
     *
     * @param packId family ID or pack ID, if ID contains version, family ID is
     *               extracted
