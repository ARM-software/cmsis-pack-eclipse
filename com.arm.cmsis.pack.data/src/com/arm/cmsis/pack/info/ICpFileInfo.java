...
public interface ICpFileInfo extends ICpFile, ICpItemInfo {
    ...
    /**
     * Sets actual resolved ICpFile to this info and optionally updates info
     * attributes
     *
    ...
    /**
     * Returns parent ICpComponentInfo if this file is a child of a component or an
     * API
     *
    ...
    /**
     * Sets file version to this object, either from actual ICpFile or a stored
     * value when the file has been copied
     *
