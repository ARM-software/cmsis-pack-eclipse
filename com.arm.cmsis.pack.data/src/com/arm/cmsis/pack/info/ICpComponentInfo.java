...
public interface ICpComponentInfo extends ICpComponent, ICpItemInfo, IEvaluationResult {
    ...
    /**
     * Sets attributes of a ICpComponentInfo based on the attributes present in the
     * component ID
     *
     * @return ICpComponentInfo with attributes
     */
    void setAttributesFromComponentId(String componentId);
}
