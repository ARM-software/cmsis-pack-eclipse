...
public class CmsisZoneHeadlessMode extends HeadlessGen{
	...
	public Object start(IApplicationContext context) throws Exception {			
		...
		if(project!= null){
			...
			// 2. extract structure of 'TestInputData' and 'GoldenData' directories from the 'com.arm.cmsis.zone.tests' plug-in to CmsisZoneTest project
		...
		// 4. Creates command line with all '.azone' files found in 'TestInputData' directory 			
		testData.createInputCommandLine(project);

		// 5. Get command line to be added into the getArguments() of the CMSIS-Zone headless mode
		...
		try {
			...
			//Note: CMSIS-Zone headless mode only generates parent 'fzone' file and 'ftl_gen' directory inside CMSIS-Zone project
			...
			// 1. Compare list of created *.txt files in the TestResults directory to the *txt files in GoldenData directory			 
			fRunTests.runTests(); 
