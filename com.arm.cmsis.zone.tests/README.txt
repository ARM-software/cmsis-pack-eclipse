-------------------------------------------------------------------------------------------------------------------------------------------------
CMSIS-Zone plug-in test (com.arm.cmsis.zone.tests)
...
RUN TESTS SUITE:
	...
	1. Click on 'CmsisZoneTestSuite.launch' file (com.arm.cmsis.zone.tests/launch_config/CmsisZoneTestSuite.launch) and select 'Run as' CmsisZoneTestSuite
...
HOW TO SEE TEST RESULTS:
	...
	1. Click on 'Eclipse Application.launch' file (com.arm.cmsis.zone.tests/launch_config/Eclipse Application.launch) and select 'Run as' Eclipse Application  
...
CREATE ADDITIONAL TEST CASES (if needed). Note: This plug-in already has 3 test cases to be tested (See 'EXISTING TEST CASES' section)
	...
	1. Copy desired new test case in TestInputData folder (com.arm.cmsis.zone.tests/TestInputData)
	...
	5. Copy whole imported project into test plugin 'com.arm.cmsis.zone.tests/GoldenResults' and change name of new test case in 'GoldenResults' folder to the missing or following test case number TC# e.g.:'TC7'
