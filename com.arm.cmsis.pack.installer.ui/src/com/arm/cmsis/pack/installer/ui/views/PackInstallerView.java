...
public abstract class PackInstallerView extends ViewPart implements IRteEventListener, ISelectionListener {
    ...
    protected String getButtonString(ButtonId buttonId) {
        switch (buttonId) {
        case BUTTON_UPTODATE:
            return Messages.PackInstallerView_BtUpToDate;
        case BUTTON_OFFLINE:
            return Messages.PackInstallerView_BtOffline;
        case BUTTON_DEPRECATED:
            return Messages.PackInstallerView_BtDeprecated;
        case BUTTON_INSTALL:
            return Messages.PackInstallerView_BtInstall;
        case BUTTON_INSTALL_PLUS:
            return Messages.PackInstallerView_BtInstallPlus;
        case BUTTON_RESOLVE:
            return Messages.PackInstallerView_BtResolve;
        case BUTTON_UPDATE:
            return Messages.PackInstallerView_BtUpdate;
        case BUTTON_UPDATE_PLUS:
            return Messages.PackInstallerView_BtUpdatePlus;
        case BUTTON_UNPACK:
            return Messages.PackInstallerView_BtUnpack;
        case BUTTON_UNPACK_PLUS:
            return Messages.PackInstallerView_BtUnpackPlus;
        case BUTTON_REMOVE:
            return Messages.PackInstallerView_BtRemove;
        case BUTTON_DELETE:
            return Messages.PackInstallerView_BtDelete;
        case BUTTON_DELETE_ALL:
            return Messages.PackInstallerView_BtDeleteAll;
        case BUTTON_COPY:
            return Messages.PackInstallerView_BtCopy;
        case BUTTON_REPOSITORY:
            return Messages.PackInstallerView_BtRepository;
        case BUTTON_COPY_REPOSITORY:
            return Messages.PackInstallerView_BtCopyRepository;
        case BUTTON_COPY_TAG:
            return Messages.PackInstallerView_BtCopyTag;
        case BUTTON_1PACK:
            return Messages.PackInstallerView_Bt1Pack;
        case BUTTON_PACKS:
            return Messages.PackInstallerView_BtPacks;
        case BUTTON_IMPORT:
            return Messages.PackInstallerView_BtImport;
        default:
            return Messages.PackInstallerView_BtUndefined;
        }
    }
    ...
    public void createPartControl(Composite parent) {
        ...
        fTree = new FilteredTree(fParentComposite, SWT.FULL_SELECTION | SWT.BORDER | SWT.H_SCROLL | SWT.V_SCROLL,
                fPatternFilter, true, true);
        ...
        fPatternFilter = new PatternFilter() {
            ...
            protected boolean isLeafMatch(final Viewer viewer, final Object element) {
                ...
                if (contentProvider instanceof ITreeContentProvider) {
                    ...
                    Object parent;
                    for (parent = treeContentProvider.getParent(element); parent != null; parent = treeContentProvider
                            .getParent(parent)) {
