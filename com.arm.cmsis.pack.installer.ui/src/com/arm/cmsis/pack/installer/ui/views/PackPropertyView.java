...
public class PackPropertyView extends PackInstallerView {
    ...
    class PackPropertyViewContentProvider extends TreeObjectContentProvider {
        ...
        private Object[] getPackChildren(ICpPack pack) {
            if (pack == null || pack.getPackState() == PackState.ERROR || pack.getChildren() == null) {
                return ITreeObject.EMPTY_OBJECT_ARRAY;
            }
         ...
         *
         * @param id     ID of the component to be added as a child of parent, used to
         ...
         * @return the child node if it has the formed ID like a.b.c, null if it does
         *         not exist
         */
        ...
        /**
         * Build the child nodes along the path like a.b.c, each segment represents a
         * child node
         *
    ...
    class PackPropertyViewLabelProvider extends ColumnLabelProvider {
        ...
        public Image getImage(Object obj) {
            ...
            case CmsisConstants.PACKAGE_TAG:
                ...
                if (isRequiredPackInstalled(familyId, item.getAttribute(CmsisConstants.VERSION))) {
                    return CpPlugInUI.getImage(CpPlugInUI.ICON_PACKAGE);
                }
                return CpPlugInUI.getImage(CpPlugInUI.ICON_PACKAGE_RED);
            default:
    ...
    boolean isRequiredPackInstalled(String familyId, String versionRange) {
        Collection<ICpPack> installedPacks = CpPlugIn.getPackManager().getInstalledPacks()
                .getPacksByPackFamilyId(familyId);
