...
public interface ICpPackInstaller extends IAdaptable {
    ...
    /**
     * Installs pack with given ID. Specify full id to install the specific version
     * or a family ID to install the latest version.
     *
    ...
    /**
     * Installs packs with given IDs. Specify full id to install the specific
     * version or a family ID to install the latest version.
     *
     ...
     *
     * @param packId               full or family pack ID
     * @param installRequiredPacks True if the required pack should also be
     *                             installed
     */
    void installPack(final String packId, boolean installRequiredPacks);

    /**
     * Installs pack with given attributes, now only used when refreshing RTE
     * project.
     *
     ...
     * @param delete true if also delete the .pack file in
     *               ${cmsis_root_folder}/.Download folder
     */
    ...
    /**
     * Extracts files from archive overwriting existing entries and setting
     ...
     * @param setReadOnly  boolean flag specifies if to sets read-only attribute the
     *                     destination entries
     * @param monitor      IProgressMonitor
     * @return True if the unzip is successful, false otherwise
     * @throws IOException
     */
    default boolean unzip(InputStream archiveInput, IPath destPath, boolean overwrite, boolean setReadOnly,
     ...
     * @throws IOException
     */
    static boolean unzipArchive(InputStream archiveInput, IPath destPath, boolean overwrite, boolean setReadOnly,
            IProgressMonitor monitor) throws IOException {
     ...
     */
    default boolean isUpdatingPacks() {
        return false;
    }
     ...
     */
    default boolean isSuppressMessages() {
        return false;
    }
     ...
     */
    default void setSuppressMessages(boolean bSuppress) {
        /* default does nothing */}
