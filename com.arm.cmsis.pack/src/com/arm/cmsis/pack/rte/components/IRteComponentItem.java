...
public interface IRteComponentItem extends ICmsisMapItem<IRteComponentItem> {
     ...
     * @param flags       COMPONENT_IGNORE_* flags describing how to resolve
     *                    components when adding ICpComponentInfo objects to the
     *                    hierarchy
     * @see RteConstants
     */
    ...
    /**
     * Sets active child for this item. Does nothing for non-exclusive items
     *
     * @param name child name to set active, if equals to default name, the first
     *             child in the collection is set active
    ...
    /**
     * Returns default child name The name does not need to be an actual key, but a
     * symbolic one, for instance component version can have "latest" special name
     *
    ...
    /**
     * Returns component attribute as string representing child key ("Cclass",
     * "Cbundle", "Cgroup", etc.)
     *
    ...
    /**
     * Matches supplied pattern to key of a child item, usually represent a value of
     * key attribute
     *
    ...
    /**
     * Returns active child or grand-child that has ICpItem That is could be group
     * (can have API), bundle version or component version
     *
    ...
    /**
     * Searches for component group in the child hierarchy (default bundle takes
     * precedence)
     *
    ...
    /**
     * Returns collection of currently used active components (those that have
     * associated {@link ICpComponentInfo})
     *
     * @param components collection to fill, if null the new collection is allocated
    ...
    /**
     * Returns collection of components associated with given generator, includes
     * generated and bootstrap ones
     *
     * @param generatorId {@link ICpGenerator} id, if null all generator-related
     *                    components are returned
     * @param components  collection to fill, if null the new collection is
     *                    allocated
     * @return collection of {@link IRteComponent} components
     */
     ...
     *
     * @param dependency {@link IRteDependency} describing search criteria and
     ...
     * Standard component representing component hierarchy ICpItems items must
     * return getName() Artificial item might return a different string to allow
     * desirable sorting
     *
     * @return item key
     */
