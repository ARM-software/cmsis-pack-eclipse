...
public class RteDependencySolver extends CpConditionContext implements IRteDependencySolver {
    ...
    /**
     * Helper class to compare component by evaluation result (descending) and
     * component name (acceding)
     */
    ...
    protected boolean isEvaluate(EEvaluationResult res) {
        ...
        // for other results do trigger calls to evaluateDependency(), it has its own
        // cache
        return !res.isFulfilled();
    }

    protected void collectDependencies(IRteDependencyResult depRes, ICpItem condition,
    ...
    /**
     * Evaluates selected components and reports unsatisfied dependencies and
     * conflicts
     */
    ...
    public EEvaluationResult resolveDependencies() {
        // try to run resolve iteration until all dependencies are resolved or no
