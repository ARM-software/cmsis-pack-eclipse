...
public interface ICpPackManager extends IRteEventListener {
    ...
    /**
     * Returns collection of all items, which contains all mounted and compatible
     * devices
     *
    ...
    /**
     * Returns collection of boards that contain mounted or compatible device
     * matching suppled device attributes
     *
    ...
    /**
     * Loads packs found in a supplied directory and sub-directories (up to 3 levels
     * deep)
     *
    ...
    /**
     * Check if pack is a local repository. Local repository means that pack is
     * installed outside RTE root path.
     *
    ...
    /**
     * Checks if pack is published on the web (does have a pdsc entry in .web
     * folder)
     *
