...
public class RteToolChainAdapterInfo {
	...
	/**
	 * Returns toolchain family : corresponds to Tcompiler filter attribute in RTE model
	 ...
	 * <dt>99<dd>adapter has no associations => generic
	 * <dt>10...39<dd>exact match of toolchain ID or its super classes ID  
	 * <dt>40...<dd>wildcard match of toolchain ID or its super classes ID  
	 * </dl> 	 
	 * */
