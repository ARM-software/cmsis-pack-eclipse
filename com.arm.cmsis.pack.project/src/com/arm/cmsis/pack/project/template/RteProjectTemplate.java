...
/**
 *  This class provides extra pages for new Project wizard and static functions helping in project creation    
 */
public class RteProjectTemplate implements IPagesAfterTemplateSelectionProvider {
	...
	public IWizardDataPage[] createAdditionalPages(IWorkbenchWizard wizard,
		...
		RteTemplateCmsisProjectPage toolChainAdapterPage = new RteTemplateCmsisProjectPage(Messages.RteProjectTemplate_CMSIS_RTE_Project, Messages.RteProjectTemplate_CMSIS_RTE_Project, null);
	...
	/**
	 * Helper method that returns selected in the main page of CDT new project wizard 
	 * @return selected IToolChain object
	 */
	public static IToolChain getSelectedToolChain() {
		Object tsProperty   = MBSCustomPageManager.getPageProperty(MBSCustomPageManager.PAGE_ID, MBSCustomPageManager.TOOLCHAIN);
