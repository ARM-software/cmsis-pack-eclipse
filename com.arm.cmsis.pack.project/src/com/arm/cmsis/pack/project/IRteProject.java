...
public interface IRteProject extends IAdaptable {
    ...
    /**
     * Loads project data, triggers reload and update of resources, dynamic files
    ...
    /**
     * Reloads RTE configuration and performs update of resources, dynamic files and
     * toolchain settings
     */
    void reload();
    ...
    /**
     * Clean-up project by removing excluded RTE config files. Default does nothing
     */
     ...
     */
    default boolean isInstallMissingPacksOnUpdate() {
        return false;
    }
     ...
     */
    default void setInstallMissingPacksOnUpdate(boolean bInstall) {
