...
public class RunTests {
    ...
    public static void resultReport(Result result) {
        String testResultJUnit = Messages.RunTests_Finish + result.getFailureCount() + Messages.RunTests_Ignored
                + result.getIgnoreCount() + Messages.RunTests_TestRun + result.getRunCount() + Messages.RunTests_Time
                + result.getRunTime() + Messages.RunTests_TimeMs;
