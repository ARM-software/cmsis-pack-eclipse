...
/**
 *  An abstract convenience class implementing IRunnableWithResult interface for Integer result.
 *  That can be useful for runnables displaying a dialog and returning its result   
 */
