...
public interface ITreeObject {
    ...
    /**
     * Destroys the object clearing it and by removing all references from it to
     * other objects
     */
    void destroy();
     ...
     *
     * @return true if this items has been destroyed and should be removed from
     *         parent's children
     */
    boolean purge();
     ...
     *
     * @return immediate parent item or null if this item has no parent or parent is
     *         unknown
     */
    Object getParent();
