...
public interface IAttributedItem {
     ...
     *
     * @return modifiable attributes as IAttributes or null if item has no
     *         attributes
     */
     ...
     * exist, does not remove existing ones
     *
    ...
    /**
     * Updates existing attributes with supplied ones, adds attributes if do not
     * exist, removes if not in supplied collection
     *
    ...
    /**
     * Returns value of an attribute present in this element or in attributes of
     * parent items (if any). Search is performed until attribute is found or parent
     * is null or parent implementation stops search
     *
     * @param key attribute key to search for
    ...
    /**
     * Checks if all attributes of this item exist in supplied map and their values
     * match. Wild card match is used
     *
    ...
    /**
     * Merges attributes from supplied attributes to this item, does not overwrite
     * existing ones
     *
