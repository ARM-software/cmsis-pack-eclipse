...
public interface ICmsisItem extends ITreeObject, ICmsisErrorCollection {
    ...
    /**
     * Items can have names (for instance specified by "name" attribute) name is
     * usually only a portion of element's ID
     *
    ...
    /**
     * Returns item name to be effectively presented to the user, e.g. decorated
     * name
     *
    ...
    /**
     * Returns if only one of its children or associated items can be active at a
     * time.
     * </p>
     * For instance an API is exclusive if only one component implementing the API
     * can be selected
     *
