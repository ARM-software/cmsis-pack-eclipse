...
/**
 * Enumeration of memory security : secure, non-secure, non-secure callable, and undefined 
 */
public enum EMemorySecurity{
	...
	/**
	 * Checks if this enum equals to another one or one of them has NOT_SPECIFIED value  
