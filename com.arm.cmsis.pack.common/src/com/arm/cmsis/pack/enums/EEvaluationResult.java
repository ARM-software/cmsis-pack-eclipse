 ...
 * <dl>
 * <dt>UNDEFINED</dt>
 * <dd>not evaluated yet
 * <dt>ERROR</dt>
 * <dd>error evaluating condition ( recursion detected or condition is missing)
 * <dt>FAILED</dt>
 * <dd>device or toolchain not match; selected component is denied
 * <dt>MISSING</dt>
 * <dd>no component is installed
 * <dt>MISSING_BUNDLE</dt>
 * <dd>no matching bundle is installed
 * <dt>MISSING_VARIANT</dt>
 * <dd>no component of specified variant is installed
 * <dt>MISSING_VENDOR</dt>
 * <dd>no component from specified vendor is installed
 * <dt>MISSING_VERSION</dt>
 * <dd>no component of specified version is installed
 * <dt>MISSING_API</dt>
 * <dd>no required api is installed
 * <dt>MISSING_API_VERSION</dt>
 * <dd>no api of required version is installed
 * <dt>UNAVAILABLE</dt>
 * <dd>component is installed but filtered out
 * <dt>UNAVAILABLE_PACK</dt>
 * <dd>component is installed but pack is not selected
 * <dt>INCOMPATIBLE</dt>
 * <dd>incompatible component is selected (result of deny expression)
 * <dt>INCOMPATIBLE_BUNDLE</dt>
 * <dd>incompatible bundle is selected
 * <dt>INCOMPATIBLE_VARIANT</dt>
 * <dd>incompatible variant of component is selected
 * <dt>INCOMPATIBLE_VENDOR</dt>
 * <dd>incompatible component vendor is selected
 * <dt>INCOMPATIBLE_VERSION</dt>
 * <dd>incompatible version of component is selected
 * <dt>INCOMPATIBLE_API</dt>
 * <dd>incompatible API version is selected
 * <dt>CONFLICT</dt>
 * <dd>more than one exclusive component selected
 * <dt>INACTIVE</dt>
 * <dd>matching component belongs to an inactive bundle
 * <dt>INSTALLED</dt>
 * <dd>more than one matching component entity is installed, choice is ambiguous
 * <dt>SELECTABLE</dt>
 * <dd>matching components are installed but not selected
 * <dt>FULFILLED
 * <dd>required component(s) selected
 * <dt>IGNORED
 * <dd>condition or expression is irrelevant for supplied context, ignored for
 * further evaluation
 * </dl>
 * </p>
 *
...
public enum EEvaluationResult {
    ...
    FULFILLED,
    /**
     * condition or expression is irrelevant for supplied context, ignored for
     * further evaluation
     */
    IGNORED;
