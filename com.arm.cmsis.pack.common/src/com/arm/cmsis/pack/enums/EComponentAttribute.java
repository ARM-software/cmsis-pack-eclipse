...
/**
 * Enumeration of component attributes Cclass, Cbundle, Cgroup, Csub, Cvariant,
 * Cvendor, Cversion, CapiVersion and condition:
 */
public enum EComponentAttribute {

    CCLASS(CmsisConstants.CCLASS), CBUNDLE(CmsisConstants.CBUNDLE), CGROUP(CmsisConstants.CGROUP),
    CSUB(CmsisConstants.CSUB), CVARIANT(CmsisConstants.CVARIANT), CVENDOR(CmsisConstants.CVENDOR),
    CVERSION(CmsisConstants.CVERSION), CAPIVERSION(CmsisConstants.CAPIVERSION), CCONDITION(CmsisConstants.CONDITION),
