...
public interface ICmsisError{
	 ...
	 */
	default String getId() {return CmsisConstants.EMPTY_STRING;}

	/**
	 * Returns severity of the error
	 * @return {@link Severity}
	 */
	default ESeverity getSeverity() { return ESeverity.None;}
	 ...
	 */
	default boolean isSevere() { return getSeverity() != null && getSeverity().isSevere(); } 
	
	/**
	 * Checks if this error is a warning  
	 * @return true if warning
	 */
	default boolean isWarning() { return getSeverity() != null && getSeverity().isWarning(); } 
	 ...
	 * @return true if info
	 */
	default boolean isInfo() { return getSeverity() != null && getSeverity().isInfo(); } 
