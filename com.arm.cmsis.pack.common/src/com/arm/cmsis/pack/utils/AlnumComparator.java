 ...
 * <li>to compare strings directly using <code>alnumCompare()</code> static
 * functions
 * </ul>
 *
 * <p/>
 * Groups of digits are converted into numbers for comparison, other characters
 * are compared in standard way. In addition string lengths are used to ensure
 * 2.01 > 2.1
 * <p>
 * In contrast, standard lexicographical string comparison treats digits as
...
public class AlnumComparator implements Comparator<String> {
     ...
     *
     * @param caseSensitive true if comparator should be case sensitive, false
     *                      otherwise
     */
     ...
     * @param str2 second string to compare
     * @param cs   case sensitive flag
     * @param cl   compare length flag, if true and result is 0 string length
     *             comparison is used
     * @return
     *         <dd><b>0</b> if str1 equals str2</dd>
    ...
    /**
     * Compares two strings alpha-numerically respecting case ignoring length (2.01
     * == 2.1)
     *
     * @param str1 - first string to compare
     * @param str2 - second string to compare
    ...
    /**
     * Compares two strings alpha-numerically ignoring case and ignoring length
     * (2.01 == 2.1)
     *
     * @param str1 - first string to compare
     * @param str2 - second string to compare
