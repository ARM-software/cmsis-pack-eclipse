...
public class CmsisZoneSystemResourcesWidget extends CmsisZoneTreeWidget {
	...
	public class SystemResourcesColumnAdvisor extends CmsisZoneColumnAdvisor {
		...
		protected void createDynamicColumnInfos(){
			addColumnInfo(new CmsisColumnInfo(Messages.CmsisZoneSystemResourcesWidget_Start, ColumnType.COLSTART, 100, true));
			addColumnInfo(new CmsisColumnInfo(Messages.CmsisZoneSystemResourcesWidget_Offset, ColumnType.COLOFFSET, 100, true));
		}
