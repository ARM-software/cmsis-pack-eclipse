...
/**
 * Headless application to process *.azone files, generate corresponding *.fzone
 * file and process templates
 */
public class HeadlessGen implements IApplication {
    ...
    public static final Integer EXIT_ERROR = Integer.valueOf(4); // important work is not done, processing is aborted
    public static final Integer EXIT_WARNING = Integer.valueOf(2); // work is only partially done, some of the tasks did
                                                                   // not succeed
    public static final Integer EXIT_INFO = Integer.valueOf(1);
