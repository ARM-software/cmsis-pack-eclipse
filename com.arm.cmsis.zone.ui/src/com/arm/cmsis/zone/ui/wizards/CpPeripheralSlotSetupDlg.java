...
public class CpPeripheralSlotSetupDlg extends CpItemTreeDialog {
	...
	protected void init() {
		...
		setTitle(fPeripheral.getName() + Messages.CpPeripheralSlotSetupDlg_SemicolonWithSpaces + Messages.CpPeripheralSlotSetupDlg_Configure + fPeripheral.getSlotName());
