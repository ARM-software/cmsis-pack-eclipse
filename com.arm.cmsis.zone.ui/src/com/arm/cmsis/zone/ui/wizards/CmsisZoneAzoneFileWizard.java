...
/**
 * This wizard. Its role is to create a new file resource in the provided
 * container. The wizard creates one file with the extension * "azone".
 */
...
public class CmsisZoneAzoneFileWizard extends Wizard implements INewWizard {
    ...
    private void doFinish(String rzoneFile, String azoneFile, IProgressMonitor monitor) throws CoreException {
        ...
        if (!result) {
            String msg = Messages.CmsisZoneAzoneFileWizard_File + azoneFileName
                    + Messages.CmsisZoneAzoneFileWizard_CouldNotBeCreated;
