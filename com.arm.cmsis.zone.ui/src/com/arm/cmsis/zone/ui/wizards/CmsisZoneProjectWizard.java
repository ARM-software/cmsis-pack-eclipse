...
public class CmsisZoneProjectWizard extends Wizard implements INewWizard {
    ...
    public void addPages() {
        ...
        resourceSourcePage = new CmsisZoneProjectRzoneFilePage(cmsisZoneProjectCreator,
                Messages.CmsisZoneProjectWizard_CmsisProject);
    ...
    public boolean performFinish() {
        ...
        // Set device info depending on selected radio button (either 'Select device' or
        // 'Use existing resource file')
