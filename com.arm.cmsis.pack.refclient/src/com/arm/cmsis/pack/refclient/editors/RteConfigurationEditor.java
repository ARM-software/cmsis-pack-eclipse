...
/**
 * An example showing how to create an RTE configuration multi-page editor.
 * This example has 2 pages:
 * <ul>
 * <li>page 0 contains an RteManagerWidget
 * <li>page 1 shows XML representation of saved configuration info
 * </ul>
 */
public class RteConfigurationEditor extends MultiPageEditorPart implements IResourceChangeListener, IRteEventListener{
