...
public class SequenceConsole extends MessageConsole {
    ...
    synchronized public static SequenceConsole openConsole(String projectName) {
        ...
        IViewPart seqView = PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage()
                .findView(SequenceView.ID);
    ...
    synchronized public static void showConsole(final SequenceConsole console) {
        Display.getDefault().asyncExec(() -> ConsolePlugin.getDefault().getConsoleManager().showConsoleView(console));
    }
