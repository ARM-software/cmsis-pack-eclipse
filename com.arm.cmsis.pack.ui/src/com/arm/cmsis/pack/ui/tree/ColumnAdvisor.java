...
public abstract class ColumnAdvisor implements IColumnAdvisor {
    ...
    protected static final Cursor CURSOR_HAND = Display.getCurrent().getSystemCursor(SWT.CURSOR_HAND); // hand cursor
                                                                                                       // for URL text
    ...
    /**
     * Handling mouse up event to display hand cursor when necessary. Default usage
     * is to opens URL for an URL control
     *
     * @param e mouse event
     */
