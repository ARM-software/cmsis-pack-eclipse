...
public class AdvisedCellLabelProvider extends StyledCellLabelProvider implements ILabelProvider {
    ...
    protected final IColumnAdvisor columnAdvisor; // column advisor necessary processing cell attributes e.g. image,
                                                  // check state
     ...
     * @return the right point of the image in the cell, can be used to calculate
     *         the starting position of the cell string
     */
    ...
    public void update(ViewerCell cell) {
        ...
        case CHECK:
            ...
            break;
        case MENU:
            break; // can only have a suffix pint image, it is drawn directly
        case TEXT:
        default:
        ...
        case COMBO:
            ...
            if (index == 0 && s != null && !s.isEmpty()) {
                // workaround: append space to the text to avoid last character truncation the
                // cells
                s += ' ';
            }
            cell.setText(s);
