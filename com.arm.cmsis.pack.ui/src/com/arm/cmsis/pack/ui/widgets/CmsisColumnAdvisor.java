...
/**
 * Abstract column adviser with array of CmsisColumnInfo objects and column
 * comparator
 *
 */
public abstract class CmsisColumnAdvisor<TController extends IRteController> extends RteColumnAdvisor<TController> {
    ...
    /**
     * Creates new AdvisedCellLabelProvider and AdvisedEditingSupport cobject for
     * the column
     *
     * @param colInfo     CmsisColumnInfo
     * @param columnIndex column index
     ...
     * @param columnIndex column index
     * @return casted associated data item, null if column has no data item of item
     *         cannot be casted
     */
