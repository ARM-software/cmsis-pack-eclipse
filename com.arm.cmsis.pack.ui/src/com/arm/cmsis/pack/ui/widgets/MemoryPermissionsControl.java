...
public class MemoryPermissionsControl extends Composite {
	...
	public void setInitialValues(IMemoryPermissions permissions, IMemoryPermissions parentPermissions, boolean bShowSecurity) {
	...
	public IMemoryPermissions getPermissions() {
		...
		if(fbShowSecurity) {
			...
			if(fPermissions.isPeripheralAccess() || !fPermissions.isExecuteAccess())
			if(security.contains(EMemorySecurity.c) && (fPermissions.isPeripheralAccess() || !fPermissions.isExecuteAccess())) {
