...
public abstract class RteWidget<TController extends IRteController> extends AttributedItem
        implements IRteEventListener {
    ...
    /**
     * Destroys the widget by destroying children and unregistering from the
     * controller and
     */
    public void destroy() {
        if (fModelController != null)
