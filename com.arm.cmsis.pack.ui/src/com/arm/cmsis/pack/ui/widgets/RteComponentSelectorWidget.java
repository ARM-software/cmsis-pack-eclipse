...
public class RteComponentSelectorWidget extends RteModelTreeWidget {
    ...
    public class RteComponentColumnAdvisor extends RteColumnAdvisor<IRteModelController> {
        ...
        /**
         * Return true if the tree item (RTE component) at column index contains a check
         * box
         *
         * @param obj
        ...
        /**
         * @param obj
         * @return a string array containing indexes starting from 0 to max instance
         *         count of the RTE component
         */
