...
public class CpPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    protected void createFieldEditors() {
        ...
        if (!CpPreferenceInitializer.isCmsisRootEditable()) {
            fCmsisRootEditor = new StringFieldEditor(CpPreferenceInitializer.CMSIS_PACK_ROOT_PREFERENCE,
            ...
            fCmsisRootEditor = new CpDirectoryFieldEditor(CpPreferenceInitializer.CMSIS_PACK_ROOT_PREFERENCE,
                    CpStringsUI.PreferencesPackRootLabel, parent);
        }
        addField(fCmsisRootEditor);
        addField(new BooleanFieldEditor(CpPreferenceInitializer.CMSIS_PACK_INSTALL_MISSING_PACKS_PREFERENCE,
                CpStringsUI.PreferencesInstallMissingPacks, SWT.NONE, parent));
    }
