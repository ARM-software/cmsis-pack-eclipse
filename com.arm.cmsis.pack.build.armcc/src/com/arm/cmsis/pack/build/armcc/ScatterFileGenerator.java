...
public class ScatterFileGenerator implements ILinkerScriptGenerator {
    ...
    protected static final String BAR_COMMENT = "; *************************************************************"; //$NON-NLS-1$
    protected static final String HEAD_COMMENT = "; ** Scatter-Loading Description File generated by RTE CMSIS Plug-in **";//$NON-NLS-1$

    protected static final String _UNINIT_ = " UNINIT "; //$NON-NLS-1$
    protected static final String SPACE = " "; //$NON-NLS-1$
    protected static final String SCT = "sct"; //$NON-NLS-1$
