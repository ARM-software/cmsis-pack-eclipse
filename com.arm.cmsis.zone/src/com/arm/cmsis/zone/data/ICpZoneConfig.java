...
public interface ICpZoneConfig extends ICpZoneItem {
     ...
     */
    default boolean isZoneModeMPU() {
        return CmsisConstants.MPU.equals(getZoneMode());
    }
     ...
     */
    default boolean isZoneModeProject() {
        return CmsisConstants.PROJECT.equals(getZoneMode());
    }
