...
public interface ICpResourceGroup extends ICpResourceItem {
	 ...
	 * @return ICpResourceGroup
	 */
	default ICpResourceGroup getMemoryGroup() { return getResourceGroup(CmsisConstants.MEMORIES);}

	/**
	 * Returns memory group, creates one if not available   
	 * @return ICpResourceGroup
	 */
	default ICpResourceGroup ensureMemoryGroup() { return ensureResourceGroup(CmsisConstants.MEMORIES);}
	 ...
	 * @return ICpResourceGroup
	 */
	default ICpResourceGroup getPeripheralsGroup() { return getResourceGroup(CmsisConstants.PERIPHERALS);}

	/**
	 * Returns peripherals group, creates one if not available   
	 * @return ICpResourceGroup
	 */
	default ICpResourceGroup ensurePeripheralsGroup() { return ensureResourceGroup(CmsisConstants.PERIPHERALS);}
	 ...
	 * Initialize group
	 */
	default void init() {/* default does nothing*/};
}
