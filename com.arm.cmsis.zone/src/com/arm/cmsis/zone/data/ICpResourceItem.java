...
public interface ICpResourceItem extends ICpZoneItem  {
	 ...
	 */
	default ICpMemoryRegion getMemoryRegion(String name) {
		return getFirstChildOfType(name, ICpMemoryRegion.class);
	}
	...
	/**
	 * Returns parent ICpMemoryRegion   
	 * @return parent ICpMemoryRegion item 
	 */
	default ICpMemoryRegion getRegion() {
		ICpResourceItem res = getParentResource();
		if(res == null)
			return null;
